...
class DetalleWidget extends StatefulWidget {
  const DetalleWidget({super.key});

  static String routeName = 'Detalle';
  static String routePath = 'detalle';
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'vuy17juk' /* Minimalist and clean house wit... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
